# Studio Melipone’s Docker container for Rubinius 2.2.6

The container is based on phusion/baseimage-docker and has rubinius 2.2.6 installed. It is intended for local development.
